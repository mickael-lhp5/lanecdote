            ...
            <div class="container h-100">
                <div class="row justify-content-center">
                    <div class="col-6 align-items-center justify-content-center">
                        ...
                        <div>
                            <button type="submit" class="btn btn-warning mb-3 " name="addMeal">NOUVEAU PLAT</button>
                        </div>
                        ...
                        <table class="table table-hover table-dark">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button type="submit" class="btn uploadDeleteButtons" name="modif1">modifier</button></td>
                                    <td><button type="submit" class="btn uploadDeleteButtons" name="supp1">supprimer</button></td>
                                </tr>
                                <tr>
                                    <th scope="row">L'Oeuf Cocotte</th>
                                    <td>Oeuf en cocotte au chorizo, gratiné au comté</td>
                                    <td><button type="submit" class="btn uploadDeleteButtons" name="modif2">modifier</button></td>
